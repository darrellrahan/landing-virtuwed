...
function Hero() {
  return (
    <section
      id="hero"
      className="mt-28 py-32 lg:py-0 lg:h-screen lg:mt-0 lg:grid grid-cols-2"
    >
      <div className="lg:bg-[url('/assets/hero-accent-lg.svg')] bg-cover relative">
        ...
        <div className="relative mb-12 w-fit mx-auto lg:translate-y-44 lg:translate-x-24 -translate-y-28">
          <Image
